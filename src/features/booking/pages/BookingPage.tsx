...
const styles: Record<string, React.CSSProperties> = {
  ...
  serviceCard: { minHeight: 146, border: '1px solid #E6D8C6', borderRadius: 12, background: '#FFFDF9', padding: 13, color: '#10281F', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: 6, outline: 'none' },
  ...
  dateButton: { height: 64, borderRadius: 11, border: '1px solid #E6D8C6', background: '#FFFDF9', color: '#10281F', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 3, outline: 'none', WebkitTapHighlightColor: 'transparent' },
  ...
  primaryButton: { width: '100%', height: 44, borderRadius: 10, background: '#0F3F31', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, fontWeight: 900, boxShadow: '0 15px 28px rgba(15,63,49,0.22)', outline: 'none', border: 'none' },
